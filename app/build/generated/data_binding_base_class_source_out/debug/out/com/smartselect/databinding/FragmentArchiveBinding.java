...
public final class FragmentArchiveBinding implements ViewBinding {
  ...
  @NonNull
  public final MaterialButton btnRestoreSelected;
  ...
  private FragmentArchiveBinding(@NonNull CoordinatorLayout rootView, @NonNull ImageButton btnBack,
      @NonNull MaterialButton btnCancelSelection, @NonNull MaterialButton btnDeleteSelected,
      @NonNull MaterialButton btnRestoreSelected, @NonNull CheckBox cbSelectAll,
      @NonNull LinearLayout layoutEmpty, @NonNull MaterialCardView layoutSelectionBar,
      @NonNull ProgressBar progressBar, @NonNull RecyclerView rvArchived,
  ...
  public static FragmentArchiveBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      MaterialButton btnRestoreSelected = ViewBindings.findChildViewById(rootView, id);
      ...
      return new FragmentArchiveBinding((CoordinatorLayout) rootView, btnBack, btnCancelSelection,
          btnDeleteSelected, btnRestoreSelected, cbSelectAll, layoutEmpty, layoutSelectionBar,
          progressBar, rvArchived, tvCount);
    }
