...
public abstract class Hilt_AdminPhonesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AdminPhonesFragment() {
    super();
  }

  Hilt_AdminPhonesFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AdminPhonesFragment_GeneratedInjector) this.generatedComponent()).injectAdminPhonesFragment(UnsafeCasts.<AdminPhonesFragment>unsafeCast(this));
    }
  }
