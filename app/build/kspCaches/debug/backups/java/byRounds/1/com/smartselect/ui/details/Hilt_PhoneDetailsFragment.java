...
public abstract class Hilt_PhoneDetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PhoneDetailsFragment() {
    super();
  }

  Hilt_PhoneDetailsFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PhoneDetailsFragment_GeneratedInjector) this.generatedComponent()).injectPhoneDetailsFragment(UnsafeCasts.<PhoneDetailsFragment>unsafeCast(this));
    }
  }
