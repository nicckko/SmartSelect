...
public abstract class Hilt_CompareFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CompareFragment() {
    super();
  }

  Hilt_CompareFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CompareFragment_GeneratedInjector) this.generatedComponent()).injectCompareFragment(UnsafeCasts.<CompareFragment>unsafeCast(this));
    }
  }
