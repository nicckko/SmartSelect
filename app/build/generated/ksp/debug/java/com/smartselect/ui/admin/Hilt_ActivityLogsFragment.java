...
public abstract class Hilt_ActivityLogsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ActivityLogsFragment() {
    super();
  }

  Hilt_ActivityLogsFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ActivityLogsFragment_GeneratedInjector) this.generatedComponent()).injectActivityLogsFragment(UnsafeCasts.<ActivityLogsFragment>unsafeCast(this));
    }
  }
