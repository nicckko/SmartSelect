...
public abstract class Hilt_EditProfileDialog extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EditProfileDialog() {
    super();
  }

  Hilt_EditProfileDialog(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EditProfileDialog_GeneratedInjector) this.generatedComponent()).injectEditProfileDialog(UnsafeCasts.<EditProfileDialog>unsafeCast(this));
    }
  }
