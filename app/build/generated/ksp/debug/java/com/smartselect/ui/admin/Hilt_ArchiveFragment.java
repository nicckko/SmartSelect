...
public abstract class Hilt_ArchiveFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ArchiveFragment() {
    super();
  }

  Hilt_ArchiveFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ArchiveFragment_GeneratedInjector) this.generatedComponent()).injectArchiveFragment(UnsafeCasts.<ArchiveFragment>unsafeCast(this));
    }
  }
