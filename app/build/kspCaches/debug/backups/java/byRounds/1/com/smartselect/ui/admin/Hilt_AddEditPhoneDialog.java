...
public abstract class Hilt_AddEditPhoneDialog extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddEditPhoneDialog() {
    super();
  }

  Hilt_AddEditPhoneDialog(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddEditPhoneDialog_GeneratedInjector) this.generatedComponent()).injectAddEditPhoneDialog(UnsafeCasts.<AddEditPhoneDialog>unsafeCast(this));
    }
  }
