...
public abstract class Hilt_CustomerOrderDetailDialog extends BottomSheetDialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CustomerOrderDetailDialog() {
    super();
  }

  Hilt_CustomerOrderDetailDialog(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CustomerOrderDetailDialog_GeneratedInjector) this.generatedComponent()).injectCustomerOrderDetailDialog(UnsafeCasts.<CustomerOrderDetailDialog>unsafeCast(this));
    }
  }
